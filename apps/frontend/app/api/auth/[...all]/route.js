...
var handlers = (0, next_js_1.toNextJsHandler)(auth_server_1.auth);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [2 /*return*/, handlers.GET(request)];
                case 2:
                    error_1 = _a.sent();
                    console.error("[XPOMAG auth] GET failed", error_1);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [2 /*return*/, handlers.POST(request)];
                case 2:
                    error_2 = _a.sent();
                    console.error("[XPOMAG auth] POST failed", error_2);
                    return [2 /*return*/, Response.json({
                            error: "AUTH_SERVICE_UNAVAILABLE",
