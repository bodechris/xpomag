...
exports.default = PostLoginPage;
var react_1 = require("react");
var navigation_1 = require("next/navigation");
var account_api_1 = require("../../../lib/account-api");
function PostLoginPage() {
    var router = (0, navigation_1.useRouter)();
    var _a = (0, react_1.useState)("Finishing sign in…"), message = _a[0], setMessage = _a[1];
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 4, , 5]);
                            return [4 /*yield*/, (0, account_api_1.accountFetch)("/status")];
                        case 1:
                            status_1 = _b.sent();
                            if (cancelled)
                                return [2 /*return*/];
                            if (!!status_1.verified) return [3 /*break*/, 3];
                        ...
                        case 2:
                            ...
                            return [2 /*return*/];
                        case 3:
                            if (!status_1.onboardingCompleted) {
