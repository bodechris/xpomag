...
function AboutPage() {
    return (<main className="aboutPage">
      <header className="aboutHeader">
        <link_1.default href="/" className="aboutBrand">XpoMag</link_1.default>
        <nav className="aboutNav" aria-label="Primary">
          <link_1.default href="/about" aria-current="page">About</link_1.default>
          <link_1.default href="/auth" className="aboutSignIn">Sign in</link_1.default>
        </nav>
      </header>
      ...
      <section className="aboutCta">
        ...
        <div className="aboutActions">
          <link_1.default href="/" className="aboutPrimary">Read XPOMAG</link_1.default>
          <link_1.default href="/auth?mode=signup" className="aboutSecondary">Create account</link_1.default>
        </div>
      </section>
